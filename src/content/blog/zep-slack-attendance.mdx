...
![Firestore 데이터 저장](/zlog/images/zep-slack/01.png)

![Slack 로그](/zlog/images/zep-slack/02.png)
...
![시스템 흐름](/zlog/images/zep-slack/03.png)

이거 잘만하면 빠르게 만들 수 있겠다!

마침 ZEP과 Slack 모두 Webhook 앱을 지원하고 있는 상태기도 했고요!

![ZEP 연동 위치](/zlog/images/zep-slack/04.png)

![Slack 웹 후크](/zlog/images/zep-slack/05.png)
...
![Slack 웹 후크 설정](/zlog/images/zep-slack/06.png)

저기 나오는 URL을 복사해서 ZEP Webhook에 연결해주면!

아래 이미지 같이 정상적으로 입/퇴장 메시지를 받아볼 수 있어요

![ZEP 웹 후크 등록](/zlog/images/zep-slack/07.png)

![Slack 테스트 로그](/zlog/images/zep-slack/08.png)
...
![시스템 흐름](/zlog/images/zep-slack/09.png)
...
![Firebase Functions](/zlog/images/zep-slack/10.png)

설명만 봐도 딱 제가 원하는 **‘HTTPS 요청을 Cloud 서버에서 응답하여 백엔드 코드를 자동으로 실행할 수 있다’** 라는 조건을 충족하네요

그래서 찾아봤어요 비용은..? 괜찮을까?

![Firebase Functions 금액](/zlog/images/zep-slack/11.png)
...
![Firebase](/zlog/images/zep-slack/12.png)

새로운 Firebase 프로젝트를 생성하시면 돼요!

그러면 메인화면이 반겨줄 텐데 딱 여기만 보시면 돼요!

![Firebase 메뉴](/zlog/images/zep-slack/13.png)
...
![Firebase Functions](/zlog/images/zep-slack/15.png)
...
![프로젝트 패키지](/zlog/images/zep-slack/14.png)
...
![출석 시스템 도입 안내](/zlog/images/zep-slack/16.png)

![출석 시스템 로그](/zlog/images/zep-slack/17.png)

![출석 시스템 웹 페이지](/zlog/images/zep-slack/18.png)
